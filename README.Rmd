...
library("scPipeVis")
```
In case installation fails, because dependencies are not on CRAN, then run the following line of code before installation of the package to manually download the dependencies:
```{r}
