...
-   **`run_scPipeVis_app()`**\
    ...
    Launch an interactive Shiny app which runs the pipeline (if needed) and allows the user to select any gene and visualise its expression on the UMAP embedding via a simple graphical interface.
