...
Refer to package vignettes for more details. An overview of the package is illustrated below. TODO
...
-   The `run_pipeline` function was written by the author and runs a typical scRNA-seq pipeline given the counts matrix/data in a `SingleCellExperiment` object. The `visualise_pipeline` fucntion was written by the author and creates typical plots which are used during exploratory scRNA-seq data analysis. Both the packages make use of functions implemented in already existing R packages made for scRNA-seq data analysis. These packages are mentioned below and their full references are in the References section below.
-   Packages used: SingleCellExperiment (Lun et al. 2016), scuttle (McCarthy et al. 2017), scater (McCarthy et al. 2017), scran (Lun et al. 2016), S4Vectors
